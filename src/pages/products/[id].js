					...
					<div className="flex flex-wrap -mx-4">
							...
							<div className="flex -mx-4 flex-wrap items-center justify-between lg:justify-start lg:items-start xl:items-center">
								<div className="w-full sm:w-auto min-w-max px-4 text-center flex sm:flex-col items-center justify-center">
									...
									{product?.images?.map((image, key) => {
										<div className="h-30 block mb-4 mr-2 sm:mr-0" key={key}>
											{/* <Image className="h-full w-full" src={image || '/token.svg'} alt="" /> */}
								...
								<div className="w-full sm:w-9/12 px-4">
									<img className="mb-5" src={product?.image || '/token.svg'} alt="" />
						...
						<div className="w-full lg:w-1/2 px-4">
							<div className="max-w-md mb-6">
								<span className="text-xs text-gray-400 tracking-wider">PRODUCT #3299803</span>
								<h2 className="mt-6 mb-4 text-4xl md:text-5xl lg:text-6xl font-heading font-medium">
									{product?.name || 'Apple iPhone 12 Pro (128GB) - Silver'}
								</h2>
								<p className="flex items-center mb-6">
									<span className="mr-2 text-sm text-blue-500 font-medium">₹</span>
									<span className="text-3xl text-blue-500 font-medium">{product?.price || '9999'}</span>
								</p>
							...
							<div className="flex flex-wrap -mx-2 mb-12">
								<div className="w-full px-2 mb-2 md:mb-0 py-3">
									<button
										onClick={buyProducts}
										className="block py-4 px-2 leading-8 font-heading font-medium tracking-tighter text-xl text-white text-center bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:bg-blue-600 rounded-xl w-full"
									>
										Buy Now
									</button>
								</div>
